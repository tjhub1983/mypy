...
_Ts = TypeVarTuple("_Ts") if sys.version_info >= (3, 11) else TypeVar("_Ts")  # type: ignore[misc]

@_type_operator
class NewProtocol(Generic[Unpack[_Ts]] if sys.version_info >= (3, 11) else Generic[_Ts]):  # type: ignore[misc]
    """
...
@_type_operator
class NewTypedDict(Generic[Unpack[_Ts]] if sys.version_info >= (3, 11) else Generic[_Ts]):  # type: ignore[misc]
    """
